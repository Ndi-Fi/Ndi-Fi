...
contract NdiFiStakingTest is Test {
    ...
    function testStake() external {
        ...
        (uint256 amount, uint256 timestamp, uint256 rewardsClaimed, bool withdrawn) = 
            stake.stakes(staker);
    ...
    function testPendingRewardsNoStake() external {
    ...
    function testRequestWithdrawal() external {
        ...
        (uint256 amount, uint256 requestedAt, bool exists) = 
            stake.withdrawalRequests(staker);
